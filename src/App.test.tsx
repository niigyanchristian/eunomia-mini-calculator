...
describe('App Theme Functionality', () => {
  ...
  it('renders login page by default', () => {
    ...
    expect(screen.queryByText("Christian's Calculator")).not.toBeInTheDocument()
  })

  it('shows calculator after successful login', async () => {
    await renderAndLogin()
    expect(screen.getByText("Christian's Calculator")).toBeInTheDocument()
  })
  ...
  it('renders with light theme by default', async () => {
    await renderAndLogin()
    const appElement = screen.getByText("Christian's Calculator").closest('.app')
